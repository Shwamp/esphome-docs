...
.. warning::
    ...
    Usage of oversampling higher then 1x, IIR filters or a higher update interval then 60s will cause the sensor
    to heat up and show inaccurate temperature readings. See *Weather monitoring* in the data sheet.
